# Technical Drawing Constructions

A curated collection of geometric construction techniques with video tutorials.

## Circle Tangent Constructions
### Q1: Construct a direct common tangent to two unequal circles
...
### Q2: Draw a common internal tangent to two given circles
>[Example img]
...
### Q2: Draw an ellipse using the four-center method
>[Example img]
...
### Q3: From a point outside the ellipse, draw the two tangents to the ellipse
...
Have a useful construction tutorial to add? Please submit a pull request or open an issue with the video link and construction description.
